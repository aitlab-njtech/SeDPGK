...
#branch1=model.load_state_dict(state['model1'])
#branch2=model.load_state_dict(state['model2'])
#branch3=model.load_state_dict(state['model3'])
#branch4=model.load_state_dict(state['model4'])
#branch5=model.load_state_dict(state['model5'])
#branch6=model.load_state_dict(state['model6'])
#student_list = [branch1, branch2, branch3, branch4, branch5, branch6]
